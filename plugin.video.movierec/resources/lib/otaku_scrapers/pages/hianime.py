...
#   plugin.video.otaku/resources/lib/pages/hianime.py
...
from ..ui import control, database, utils
from ..ui.BrowserBase import BrowserBase
from ..endpoints import malsync
from ..ui.megacloud_extractor import extract_megacloud_sources
